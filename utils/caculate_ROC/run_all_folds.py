...
from FROC import process_fold_data  # 直接导入FROC.py中的函数


def run_fold_processing(csv_path: str, fold_number: int, num_folds: int, output_dir: str = "./froc_results"):
    """
    运行单个折的处理
    """
    # 构建模型路径
...
def main():
    ...
    parser.add_argument("--start_fold", type=int, default=0,
                        help="起始折数")
    parser.add_argument("--output_dir", type=str, default="./froc_results-3D",
                        help="输出目录")
